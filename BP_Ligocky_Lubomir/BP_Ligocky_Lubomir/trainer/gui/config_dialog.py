...
class Ui_Dialog(object):
    def setupUi(self, Dialog, base_speach_lang: dict = {}):
        ...
        self.retranslateUi(Dialog, base_speach_lang)

        QMetaObject.connectSlotsByName(Dialog)
    # setupUi

    def retranslateUi(self, Dialog, base_speach_lang: dict = {}):
        title = base_speach_lang.get("title", u"Dialog")
        physical_properties = base_speach_lang.get("conf_dialog", {}).get("physical_properties", "Physical")
        virtual_robot_ip = base_speach_lang.get("conf_dialog", {}).get("virtual_robot_ip", "Virtual Robot IP")
        physical_robot_ip = base_speach_lang.get("conf_dialog", {}).get("physical_robot_ip", "Physical Robot IP")
        server_port = base_speach_lang.get("conf_dialog", {}).get("server_port", "Physical")
        server_ip = base_speach_lang.get("conf_dialog", {}).get("server_ip", "Server IP")
        exercise_duration = base_speach_lang.get("conf_dialog", {}).get("exercise_duration", "Exercise duration")
        male = base_speach_lang.get("conf_dialog", {}).get("male", "Male")
        female = base_speach_lang.get("conf_dialog", {}).get("female", "Female")
        participant_gender = base_speach_lang.get("conf_dialog", {}).get("participant_gender", "Participant gender")
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", unicodedata.normalize('NFKD',title), None))
        self.label.setText(QCoreApplication.translate("Dialog", unicodedata.normalize('NFKD',server_ip), None))
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog", unicodedata.normalize('NFKD',virtual_robot_ip), None))
        self.physical_checkBox.setText(QCoreApplication.translate("Dialog", unicodedata.normalize('NFKD',physical_properties), None))
        self.label_3.setText(QCoreApplication.translate("Dialog", unicodedata.normalize('NFKD',server_port), None))
        self.serverPort_edit.setText(QCoreApplication.translate("Dialog", u"1234", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", unicodedata.normalize('NFKD',physical_robot_ip), None))
        ...
        self.label_exercise_loop.setText(QCoreApplication.translate("Dialog", unicodedata.normalize('NFKD',exercise_duration), None))
        self.groupBox.setTitle("")
        self.radioButton_male.setText(QCoreApplication.translate("Dialog", male, None))
        self.radioButton_female.setText(QCoreApplication.translate("Dialog",female, None))
        self.label_gender.setText(QCoreApplication.translate("Dialog",participant_gender, None))
    # retranslateUi
