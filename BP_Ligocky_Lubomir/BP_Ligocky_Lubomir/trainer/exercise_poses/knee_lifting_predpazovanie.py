...
class KneeLiftingPredpazovaniePose(BasicForefootingExercise):
    ...
    def __init__(self):
        super().__init__()
        self.curr_exercise_name = "knee_lifting_predpazovanie_exercise"
        ...
        self.emit_msg_legs = ''
        self.emit_msg_arms = ''
        self.sit_forefooting_on_chair_sent00 = False # has to be False

    # do not reset any state here
    ...
    def do_check_exercise(self, landmarks, stage_signal, exercise_label_signal, score_signal, depth = None, frame = None):
        ...
        if self.sit_forefooting_on_chair_sent00 == False:
            if is_person_sitting is True:
                stage_signal.emit("00,", "knee_lifting_predpazovanie_fullfilled",self.camera_exerice_score) # 0. faza - uz sedi, zdvihneme mu pravu nohu
        ...
        if self.sit_forefooting_on_chair_sent01 == False and self.sit_forefooting_on_chair_sent00 == True:
            ...
            if is_right_leg_raised is True and arms_raised_forward is True:
                ...
                if self.correct_pose_time_treshold == None:
                    ...
                    stage_signal.emit("01,", "knee_lifting_predpazovanie_fullfilled", self.camera_exerice_score) # 1. faza - uz ju zdvihol, dame ju naspat
                ...
                if is_right_leg_raised is False:
                    self.leg_wrong = True
                    self.emit_msg_legs = "knee_liftingPred_a_zdvihni_pravu_nohu"
        ...
        if self.sit_forefooting_on_chair_sent02 == False and self.sit_forefooting_on_chair_sent01 == True and self.sit_forefooting_on_chair_sent00 == True:
            if is_right_leg_raised is False and arms_raised_forward is False:
                stage_signal.emit("02,", "knee_lifting_predpazovanie_fullfilled", self.camera_exerice_score) # 2. faza - uz ju dal naspat, zdvihame lavu nohu
        ...
        if self.sit_forefooting_on_chair_sent03 == False and self.sit_forefooting_on_chair_sent02 == True and self.sit_forefooting_on_chair_sent01 == True and self.sit_forefooting_on_chair_sent00 == True:
            if is_left_leg_raised is True and arms_raised_forward is True :
                if self.correct_pose_time_treshold == None:
                    ...
                    stage_signal.emit("03,", "knee_lifting_predpazovanie_fullfilled", self.camera_exerice_score) # 3. faza - dal aj lavu nohu naspat
                ...
                if is_left_leg_raised is False:
                    self.leg_wrong = True
                    self.emit_msg_legs = "knee_liftingPred_a_zdvihni_lavu_nohu"
        ...
        if self.sit_forefooting_on_chair_sent04 == False and self.sit_forefooting_on_chair_sent03 == True and self.sit_forefooting_on_chair_sent02 == True and self.sit_forefooting_on_chair_sent01 == True and self.sit_forefooting_on_chair_sent00 == True :
            ...
            if is_left_leg_raised is False and arms_raised_forward is False:
                stage_signal.emit("04,", "knee_lifting_predpazovanie_fullfilled", self.camera_exerice_score)
    ...
    def warning_message(self, both_arms, side_arm, right_arm_up, left_arm_up, right_arm_low,left_arm_low, right_arm_aside, left_arm_aside, front_or_back: str="front"):
        if both_arms:
