...
class ForefootingLyingPose(ExerciseBase):
    ...
    def __init__(self):
        ...
        self.curr_exercise_name = "forefooting_in_lying"
    ...
    def do_check_exercise(self, landmarks, stage_signal, exercise_label_signal, score_signal, depth=None, frame=None):
        ...
        if self.sit_forefooting_in_lying_sent00 == False:
            if is_person_lying_init is True:
                stage_signal.emit("00,", "forefooting_in_lying_fullfilled",
                                  self.camera_exerice_score)  # 0. faza - uz lezi, zdvihneme mu pravu nohu
        ...
        if self.sit_forefooting_in_lying_sent01 == False and self.sit_forefooting_in_lying_sent00 == True:
            if is_left_arm_lifted_when_lying is True and is_right_arm_lifted_when_lying is True:
                self.wrong_pose_msg = "raised_both_hands"
            elif is_left_arm_lifted_when_lying is True:
                self.wrong_pose_msg = "raised_left_hand"
            elif is_right_arm_lifted_when_lying is True:
                self.wrong_pose_msg = "raised_right_hands"
            ...
            if right_leg_lifted is True and is_left_arm_lifted_when_lying is True:
                ...
                if self.check_correct_pose_timer(0.5):
                    stage_signal.emit("01,", "forefooting_in_lying_fullfilled",
                                      self.camera_exerice_score)  # 1. faza - uz ju zdvihol, dame ju naspat
                ...
                elif right_leg_lifted is False:
                        if lift_leg1 == 1:
        ...
        if self.sit_forefooting_in_lying_sent02 == False and self.sit_forefooting_in_lying_sent01 == True and self.sit_forefooting_in_lying_sent00 == True:
            if right_leg_lifted is False and is_person_lying_init is True:
                stage_signal.emit("02,", "forefooting_in_lying_fullfilled",
                                  self.camera_exerice_score)  # 2. faza - uz ju dal naspat, zdvihame lavu nohu
        ...
        if self.sit_forefooting_in_lying_sent03 == False and self.sit_forefooting_in_lying_sent02 == True and self.sit_forefooting_in_lying_sent01 == True and self.sit_forefooting_in_lying_sent00 == True:
            ...
            if left_leg_lifted is True:
                ...
                if self.check_correct_pose_timer(0.5):
                    stage_signal.emit("03,", "forefooting_in_lying_fullfilled",
                                      self.camera_exerice_score)  # 3. faza - dal aj lavu nohu naspat
    ...
    def do_check_exercise2(self, landmarks, stage_signal, exercise_label_signal, score_signal, depth = None, frame = None):
        is_person_lying_init = self.lying_poses.is_person_lying_on_floor_init(landmarks)
