...
class ForefootingPredpazovanie(RobotExerciseUtils):
    ...
    def __init__(self, naoqi_instance):
        ...
        self.exercise_name = "forefooting_predpazovanie"
    ...
    def run_exercise(self, score, message, pending_messages, phase, conn):
        ...
        if message == 'forefooting_predpazovanie':
            if self.finished_phases["0"] == False:  # We put robot to sit first, so we do it in start
            ...
            elif self.finished_phases["1"] == False and self.finished_phases["0"] == True:
            ...
            elif self.finished_phases["2"] == False and self.finished_phases["1"] == True:
            ...
            elif self.finished_phases["3"] == False and self.finished_phases["2"] == True:
            ...
            elif self.finished_phases["4"] == False and self.finished_phases["3"] == True:
    ...
    def warning_say(self, message):
        ...
        if "ForefootingPred_a_zdvihni_pravu_nohu" in message:
            sentence_to_say = self.warning_sentences.get(
                "ForefootingPred_a_zdvihni_pravu_nohu", "Zdvihniťe pravú nohu.")
            self.naoqi.speak_or_message(sentence_to_say)
            leg_wrong = True
            
        if "ForefootingPred_a_zdvihni_lavu_nohu" in message:
            sentence_to_say = self.warning_sentences.get(
                "ForefootingPred_a_zdvihni_lavu_nohu", "Zdvihniťe ľavú nohu.")
            self.naoqi.speak_or_message(sentence_to_say)
            leg_wrong = True

        if "In_Base_pos_left" in message:
            sentence_to_say = self.warning_sentences.get(
                "In_Base_pos_left", "Predpažťe ruky a zdvihniťe ľavú nohu.")
            self.naoqi.speak_or_message(sentence_to_say)
            return
        
        elif "In_Base_pos_right" in message:
            sentence_to_say = self.warning_sentences.get(
                "In_Base_pos_right", "Predpažťe ruky a zdvihniťe pravú nohu.")
            self.naoqi.speak_or_message(sentence_to_say)
            return
        ...
        # - predpazenie
            ...
            if leg_wrong is True:
                ...
                sentence_to_say = naoqi_speech_options.get(
                    "leg_wrong", "Potom posuň ruky nižšie na vodorovnú polohu a bližšie k sebe.")
                self.naoqi.speak_or_message(sentence_to_say)
            else:
                sentence_to_say = naoqi_speech_options.get(
                    "leg_right", "Posuň ruky nižšie na vodorovnú polohu a bližšie k sebe.")
                self.naoqi.speak_or_message(sentence_to_say)
            ...
            if leg_wrong is True:
                ...
                sentence_to_say = naoqi_speech_options.get(
                    "leg_right", "Daj ruky nižšie na vodorovnú polohu a do správnej polohy.")
                self.naoqi.speak_or_message(sentence_to_say)
            ...
            if leg_wrong is True:
                ...
                sentence_to_say = naoqi_speech_options.get(
                    "leg_right", "Skúste ruky posunut vyššie na vodorovnú polohu.")
                self.naoqi.speak_or_message(sentence_to_say)
