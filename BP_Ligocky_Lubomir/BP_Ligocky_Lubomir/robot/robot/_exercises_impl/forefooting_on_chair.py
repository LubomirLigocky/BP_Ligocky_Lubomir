...
class ForefootingOnChair(RobotExerciseUtils):
    ...
    def __init__(self, naoqi_instance):
        ...
        self.exercise_name = "forefooting_on_chair"
        ...
        self.starting_sentence = self.exercise_speach_lang.get("on_start", {}).get(
            "default", "Začíname cvičiť prednožovaňie na stoličke.")
        self.ending_sentence = self.exercise_speach_lang.get("on_end", {}).get("default",
                                                                               "Koniec cviku prednožovaňia na stoličke. Pripravíme sa na ďalší cvik.")
