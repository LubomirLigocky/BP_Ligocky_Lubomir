...
class CameraThread(QThread):
    ...
    def __init__(self, app_instance_arg):
    ...
    usb_brio_input = 8 # cable input number for cv2 from usb-c
                ...
                if self.can_detect_em:
                    ...
                    for i in range(detections.shape[2]):
                        ...
                        if confidence > 0.45:
                            ...
                            #face_upscaled = cv2.resize(face_crop, None, fx=1.25, fy=1.25)
    ...
    def initialize_fer(self, can_detect_em, fer_model): # Set up face emotion recognition
        ...
        if self.can_detect_em and fer_model != None:
    ...
    def check_current_exercise(self):
        ...
        if landmarks and self.current_exercise.exercise_lock is False:
            self.current_exercise.do_check_exercise(landmarks, self.stage_signal,  self.exercise_label_signal,  self.score_signal, depth)
